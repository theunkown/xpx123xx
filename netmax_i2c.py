...
class netmax_I2C(object):
    """ netmax Industries I2C drivers for hardware and software I2C busses """
    ...
    def __init__(self, bus, address, big_endian = True):
        ...
        if bus == "RPI_1":
            ...
            self.bus_name = bus
            self.i2c_bus = netmax_I2C_RPI_1SW()
        ...
        self.mutex = netmax_mutex.netmax_Mutex(name = ("I2C_Bus_" + bus))
...
class netmax_I2C_RPI_1SW(object):
    """netmax Industries I2C bit-bang drivers for the Raspberry Pi"""
